/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env.example` (hash: ab47dbcc172168bbb5fbe0a58ac9ba57)
// Runtime types generated with workerd@1.20260722.1 2026-07-18 nodejs_compat
interface __BaseEnv_Env {
	...
	ASSETS: Fetcher;
	APP_ORIGIN: "https://aamirazad.com" | "http://localhost:3000";
	...
	PUBLISH_WORKFLOW: Workflow<{ jobId: string }>;
}
declare namespace Cloudflare {
	interface PreviewEnv {
		...
		IMAGES: ImagesBinding;
		ASSETS: Fetcher;
		APP_ORIGIN: "https://aamirazad.com";
		ENVIRONMENT: "preview";
		OIDC_CLIENT_ID: string;
		OIDC_CLIENT_SECRET: string;
		OIDC_DISCOVERY_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "ENVIRONMENT" | "OIDC_CLIENT_ID" | "OIDC_CLIENT_SECRET" | "OIDC_DISCOVERY_URL" | "OIDC_OWNER_SUB" | "SESSION_SECRET">> {}
}
