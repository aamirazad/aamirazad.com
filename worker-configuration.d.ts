/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env.example` (hash: f6a501ac9dff78d1fd6cefc353c3eaf2)
...
interface __BaseEnv_Env {
	...
	ASSETS: Fetcher;
	APP_ORIGIN: "https://preview.aamirazad.com" | "https://aamirazad.com" | "http://localhost:3000";
...
declare namespace Cloudflare {
	interface PreviewEnv {
		...
		IMAGES: ImagesBinding;
		ASSETS: Fetcher;
		APP_ORIGIN: "https://preview.aamirazad.com";
		ENVIRONMENT: "preview";
		OIDC_CLIENT_ID: string;
		OIDC_CLIENT_SECRET: string;
		OIDC_DISCOVERY_URL: string;
